...
public class FlockController : MonoBehaviour
{
	...
	public void Start()
	{
		...
		{
			((MonoBehaviour)this).InvokeRepeating("SetFlockRandomPosition", _randomPositionTimer, _randomPositionTimer);
		}
	}
	...
	public void AddChild(int amount)
	{
		...
		{
			FlockChild flockChild = Object.Instantiate<FlockChild>(_childPrefab);
			flockChild._spawner = this;
			_roamers.Add(flockChild);
			AddChildToParent(((Component)flockChild).transform);
		}
	}
	...
	public void RemoveChild(int amount)
	{
		for (int i = 0; i < amount; i++)
		{
			...
			Object.Destroy((Object)(object)((Component)flockChild).gameObject);
		}
	}
	...
	public void InstantiateGroup()
	{
		...
		if (!((Object)(object)_groupTransform != (Object)null))
		{
			...
			{
				((Object)val).name = ((Object)_thisT).name + " Fish Container";
			}
		}
	}
	...
	public void destroyBirds()
	{
		for (int i = 0; i < _roamers.Count; i++)
		{
			Object.Destroy((Object)(object)((Component)_roamers[i]).gameObject);
		}
		_childAmount = 0;
		_roamers.Clear();
	}
