...
public class BlendSkyProfiles : MonoBehaviour
{
	...
	public SkyProfile StartBlending(TimeOfDayController controller, SkyProfile fromProfile, SkyProfile toProfile, float duration)
	{
		...
		{
			Debug.LogWarning((object)"Can't transition with null TimeOfDayController");
			return null;
		}
		if ((Object)(object)fromProfile == (Object)null)
		{
			Debug.LogWarning((object)"Can't transition to null 'from' sky profile.");
			return null;
		}
		if ((Object)(object)toProfile == (Object)null)
		{
			Debug.LogWarning((object)"Can't transition to null 'to' sky profile");
			return null;
		}
		if (!fromProfile.IsFeatureEnabled("GradientSkyFeature") || !toProfile.IsFeatureEnabled("GradientSkyFeature"))
		{
			Debug.LogWarning((object)"Sky Studio doesn't currently support automatic transition blending with cubemap backgrounds.");
		}
		...
		blendedProfile = Object.Instantiate<SkyProfile>(fromProfile);
	...
	{
		if (!((Object)(object)m_TimeOfDayController == (Object)null))
		{
	...
	private void Update()
	{
		if (!((Object)(object)blendedProfile == (Object)null))
		{
			UpdateBlendedProfile();
		}
	}
	...
	private void UpdateBlendedProfile()
	{
		...
		if (m_State.progress > 0.5f && m_IsBlendingFirstHalf)
		{
			...
			blendedProfile = Object.Instantiate<SkyProfile>(toProfile);
		...
		{
			if (!((Object)(object)featureBlender == (Object)null))
			{
