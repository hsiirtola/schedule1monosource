...
public class LightningController : MonoBehaviour, ISkyModule
{
	...
	private void Start()
	{
		...
		{
			Debug.LogWarning((object)"Can't render lightning since GPU instancing is not supported on this platform.");
	...
	public void Update()
	{
		...
		else if (!((Object)(object)m_SkyProfile.lightningArtSet == (Object)null) && m_SkyProfile.lightningArtSet.lightingStyleItems != null && m_SkyProfile.lightningArtSet.lightingStyleItems.Count != 0)
		{
	...
	public void CreateLightningRenderers()
	{
		...
		for (int i = 0; i < m_SkyProfile.lightningArtSet.lightingStyleItems.Count; i++)
		{
			...
			((Component)lightningRenderer).transform.parent = ((Component)this).transform;
