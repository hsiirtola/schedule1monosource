...
public class RainSplashController : MonoBehaviour, ISkyModule
{
	...
	private void Start()
	{
		...
		{
			Debug.LogWarning((object)"Can't render rain splashes since GPU instancing is not supported on this platform.");
	...
	private void Update()
	{
		if ((Object)(object)m_SkyProfile == (Object)null || !m_SkyProfile.IsFeatureEnabled("RainSplashFeature"))
		{
			ClearSplashRenderers();
			return;
		}
		if ((Object)(object)m_SkyProfile.rainSplashArtSet == (Object)null || m_SkyProfile.rainSplashArtSet.rainSplashArtItems == null || m_SkyProfile.rainSplashArtSet.rainSplashArtItems.Count == 0)
		{
			ClearSplashRenderers();
			return;
		}
	...
	public void CreateSplashRenderers()
	{
		...
		for (int i = 0; i < m_SkyProfile.rainSplashArtSet.rainSplashArtItems.Count; i++)
		{
			...
			((Component)rainSplashRenderer).transform.parent = ((Component)this).transform;
