...
public class SkyMaterialController
{
	...
	public Cubemap BackgroundCubemap
	{
		...
		set
		{
			...
			SkyboxMaterial.SetTexture("_MainTex", (Texture)(object)_backgroundCubemap);
		}
	}
	...
	public Texture2D StarLayer1DataTexture
	{
		...
		set
		{
			...
			SkyboxMaterial.SetTexture("_StarLayer1DataTex", (Texture)(object)value);
		}
	}
	...
	public Texture2D StarLayer2DataTexture
	{
		...
		set
		{
			...
			SkyboxMaterial.SetTexture("_StarLayer2DataTex", (Texture)(object)value);
		}
	}
	...
	public Texture2D StarLayer3DataTexture
	{
		...
		set
		{
			...
			SkyboxMaterial.SetTexture("_StarLayer3DataTex", (Texture)(object)value);
		}
	}
	...
	public Vector3 MoonDirection
	{
		...
		set
		{
			...
			_moonDirection = ((Vector3)(ref value)).normalized;
			SkyboxMaterial.SetVector("_MoonPosition", Vector4.op_Implicit(_moonDirection));
		}
	}
	...
	public Vector3 SunDirection
	{
		...
		set
		{
			...
			//IL_0019: Unknown result type (might be due to invalid IL or missing references)
			//IL_001e: Unknown result type (might be due to invalid IL or missing references)
			_sunDirection = ((Vector3)(ref value)).normalized;
			SkyboxMaterial.SetVector("_SunPosition", Vector4.op_Implicit(_sunDirection));
		}
	}
	...
	public Texture CloudTexture
	{
		get
		{
			if (!((Object)(object)_cloudTexture != (Object)null))
			{
				return (Texture)(object)Texture2D.blackTexture;
			}
	...
	public Texture ArtCloudCustomTexture
	{
		get
		{
			if (!((Object)(object)_artCloudCustomTexture != (Object)null))
			{
				return (Texture)(object)Texture2D.blackTexture;
			}
	...
	public Vector3 CloudCubemapNormalLightDirection
	{
		...
		set
		{
			...
			SkyboxMaterial.SetVector("_CloudCubemapNormalToLight", Vector4.op_Implicit(_cloudCubemapNormalLightDirection));
		}
	}
	...
	{
		float num = Mathf.Clamp(_gradientFadeBegin + _gradientFadeLength, -1f, 1f);
		SkyboxMaterial.SetFloat("_GradientFadeBegin", _gradientFadeBegin);
		SkyboxMaterial.SetFloat("_GradientFadeEnd", num);
	}

	private void ApplyStarFadeValuesOnMaterial()
	{
		float num = Mathf.Clamp(_starFadeBegin + _starFadeLength, -1f, 1f);
		SkyboxMaterial.SetFloat("_StarFadeBegin", _starFadeBegin);
		SkyboxMaterial.SetFloat("_StarFadeEnd", num);
	}
}
