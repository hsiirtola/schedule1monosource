...
public class Standard3dShaderDefinition : BaseShaderDefinition
{
	...
	protected override ProfileFeatureSection[] ProfileFeatureSection()
	{
		return new ProfileFeatureSection[10]
		{
			...
			new ProfileFeatureSection("Sky", "SkySectionKey", new ProfileFeatureDefinition[2]
			{
				ProfileFeatureDefinition.CreateShaderFeature("VertexGradientSkyFeature", "VERTEX_GRADIENT_BACKGROUND", value: false, "Use Vertex Gradient (Faster)", null, dependsOnValue: false, "If enabled the background gradient colors will be calculated per vertex (which is very fast on low-end hardware) as opposed to per pixel fragment."),
				ProfileFeatureDefinition.CreateBooleanFeature("AmbientLightGradient", value: false, "Ambient Light Gradient", null, dependsOnValue: false, "If enabled updates the ambient light colors in located in Lighting -> Environment Lighting. It's useful to adjust ambient lighting in day/night cycles for a more immersive effect.")
			}),
	...
	protected override ProfileGroupSection[] ProfileDefinitionTable()
	{
		...
		{
			new ProfileGroupSection("Sky", "SkySectionKey", "SkySectionIcon", null, dependsOnValue: false, new ProfileGroupDefinition[13]
			{
				...
				ProfileGroupDefinition.ColorGroupDefinition("Ambient Light - Sky Color", "AmbientLightSkyColorKey", Color.gray, "AmbientLightGradient", dependsOnValue: true, "Adjust the environments ambient light sky color. This affects the environment lighting, not the actual sky color."),
				ProfileGroupDefinition.ColorGroupDefinition("Ambient Light - Equator Color", "AmbientLightEquatorColorKey", Color.gray, "AmbientLightGradient", dependsOnValue: true, "Adjust the environments ambient light equator color. This affects the environment lighting, not the actual sky color."),
				ProfileGroupDefinition.ColorGroupDefinition("Ambient Light - Ground Color", "AmbientLightGroundColorKey", Color.black, "AmbientLightGradient", dependsOnValue: true, "Adjust the environments ambient light ground color. This affects the environment lighting, not the actual sky color."),
			...
			new ProfileGroupSection("Sun", "SunSectionKey", "SunSectionIcon", "SunFeature", dependsOnValue: true, new ProfileGroupDefinition[14]
			{
			...
			new ProfileGroupSection("Moon", "MoonSectionKey", "MoonSectionIcon", "MoonFeature", dependsOnValue: true, new ProfileGroupDefinition[14]
			{
			...
			new ProfileGroupSection("Clouds", "CloudSectionKey", "CloudSectionIcon", "CloudFeature", dependsOnValue: true, new ProfileGroupDefinition[30]
			{
				...
				ProfileGroupDefinition.NumberGroupDefinition("Cloud Fade-Out Amount", "CloudFadeAmountKey", 0f, 1f, 0.75f, "NoiseCloudFeature", dependsOnValue: true, "This is the amount of fade out that will happen to clouds as they reach the horizon. It creates a smooth fadeout towards the horizon."),
				ProfileGroupDefinition.NumberGroupDefinition("Cloud Transparency", "CloudAlphaKey", 0f, 1f, 1f, "CloudFeature", dependsOnValue: true, "Overall transparency of the clouds. This is useful for fading clouds in or out, or creating a softer cloud style.")
			}),
			new ProfileGroupSection("Fog", "FogSectionKey", "FogSectionIcon", "FogFeature", dependsOnValue: true, new ProfileGroupDefinition[4]
			{
				...
				ProfileGroupDefinition.NumberGroupDefinition("Fog End Distance", "FogEndDistanceKey", 0f, 1f, 0.12f, "End distance of the fog."),
