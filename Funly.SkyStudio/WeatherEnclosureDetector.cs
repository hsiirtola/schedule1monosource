...
public class WeatherEnclosureDetector : MonoBehaviour
{
	...
	{
		WeatherEnclosure componentInChildren = ((Component)other).gameObject.GetComponentInChildren<WeatherEnclosure>();
	...
	{
		WeatherEnclosure componentInChildren = ((Component)other).gameObject.GetComponentInChildren<WeatherEnclosure>();
		if (Object.op_Implicit((Object)(object)componentInChildren) && triggeredEnclosures.Contains(componentInChildren))
		{
			triggeredEnclosures.Remove(componentInChildren);
			ApplyEnclosure();
		}
	...
	public void ApplyEnclosure()
	{
		...
		if (triggeredEnclosures.Count > 0)
		{
			...
			if (!Object.op_Implicit((Object)(object)weatherEnclosure))
			{
				Debug.LogError((object)"Failed to find mesh renderer on weather enclosure, using main enclosure instead.");
