...
public static class GUIDManager
{
	...
	public static void RegisterObject(IGUIDRegisterable obj, GameObject go = null)
	{
		if (registeredGUIDs.Contains(obj.GUID))
		{
			ScheduleOne.Console.LogWarning("RegisterObject called and passed obj whose GUID is already registered. Replacing old entries with new", (Object)(object)go);
