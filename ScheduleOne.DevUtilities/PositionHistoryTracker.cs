...
public class PositionHistoryTracker : MonoBehaviour
{
	...
	private void RecordPosition()
	{
		...
		positionHistory.Add(((Component)this).transform.position);
	...
	public Vector3 GetPositionXSecondsAgo(float secondsAgo)
	{
		...
		int num = (int)(secondsAgo / recordingFrequency);
		num = Mathf.Clamp(num, 0, positionHistory.Count - 1);
		return positionHistory[num];
	}
