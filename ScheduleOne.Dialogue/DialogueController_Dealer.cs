...
public class DialogueController_Dealer : DialogueController
{
	...
	{
		if (((Object)DialogueHandler.activeDialogue).name == "Supplier_Recruitment" && dialogueLabel == "ENTRY")
		{
	...
	{
		if (((Object)DialogueHandler.activeDialogue).name == "Supplier_Recruitment" && choiceLabel == "CONFIRM")
		{
	...
	{
		if (((Object)DialogueHandler.activeDialogue).name == "Supplier_Recruitment" && choiceLabel == "CONFIRM" && NetworkSingleton<MoneyManager>.Instance.cashBalance < Dealer.SigningFee)
		{
