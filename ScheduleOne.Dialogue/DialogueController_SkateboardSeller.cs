...
public class DialogueController_SkateboardSeller : DialogueController
{
	...
	public override void ChoiceCallback(string choiceLabel)
	{
		...
		if (choiceLabel == "CONFIRM" && chosenWeapon != null)
		{
			...
			if (((BaseItemDefinition)chosenWeapon.Item).ID == "goldenskateboard")
			{
				AchievementManager.UnlockAchievement(AchievementManager.EAchievement.ROLLING_IN_STYLE);
			}
			if (onPurchase != null)
			{
				onPurchase.Invoke();
	...
	{
		if (dialogueLabel == "ENTRY" && ((Object)DialogueHandler.activeDialogue).name == "Skateboard_Sell")
		{
