...
public class CountdownExplosion : MonoBehaviour
{
	...
	public void Trigger()
	{
		countdownRoutine = ((MonoBehaviour)Singleton<CoroutineService>.Instance).StartCoroutine(Routine());
		IEnumerator Routine()
		{
			...
			{
				NetworkSingleton<CombatManager>.Instance.CreateExplosion(((Component)this).transform.position, ExplosionData.DefaultSmall);
			}
	...
	public void StopCountdown()
	{
		...
		{
			((MonoBehaviour)Singleton<CoroutineService>.Instance).StopCoroutine(countdownRoutine);
		}
	}
}
