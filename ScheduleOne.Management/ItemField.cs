...
public class ItemField : ConfigField
{
	...
	{
		return (Object)(object)SelectedItem == (Object)null;
	}

	public ItemFieldData GetData()
	{
		return new ItemFieldData(((Object)(object)SelectedItem != (Object)null) ? ((BaseItemDefinition)SelectedItem).ID.ToString() : "");
	}
