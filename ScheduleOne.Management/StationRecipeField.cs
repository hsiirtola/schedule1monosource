...
public class StationRecipeField : ConfigField
{
	...
	{
		return (Object)(object)SelectedRecipe == (Object)null;
	}

	public StationRecipeFieldData GetData()
	{
		return new StationRecipeFieldData(((Object)(object)SelectedRecipe != (Object)null) ? SelectedRecipe.RecipeID.ToString() : "");
	}
