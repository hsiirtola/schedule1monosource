...
public class ATM : NetworkBehaviour, IGUIDRegisterable, IGenericSaveable
{
	...
	protected virtual void Start()
	{
		...
		instance2.onWeekPass = (Action)Delegate.Combine(instance2.onWeekPass, new Action(WeekPass));
	...
	{
		if (!IsBroken && (impact.ImpactForce >= 150f || impact.ImpactType == EImpactType.Bullet))
		{
			SendBreak();
	...
	public override void NetworkInitialize___Early()
	{
		...
		if (!NetworkInitialize___EarlyScheduleOne_002EMoney_002EATMAssembly_002DCSharp_002Edll_Excuted)
		{
			...
			((NetworkBehaviour)this).RegisterServerRpc(0u, new ServerRpcDelegate(RpcReader___Server_SendBreak_2166136261));
			((NetworkBehaviour)this).RegisterObserversRpc(1u, new ClientRpcDelegate(RpcReader___Observers_Break_328543758));
			((NetworkBehaviour)this).RegisterTargetRpc(2u, new ClientRpcDelegate(RpcReader___Target_Break_328543758));
			((NetworkBehaviour)this).RegisterObserversRpc(3u, new ClientRpcDelegate(RpcReader___Observers_Repair_2166136261));
			((NetworkBehaviour)this).RegisterServerRpc(4u, new ServerRpcDelegate(RpcReader___Server_DropCash_2166136261));
		}
	}
