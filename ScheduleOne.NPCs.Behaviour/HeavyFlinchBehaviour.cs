...
public class HeavyFlinchBehaviour : Behaviour
{
	...
	public override void Activate()
	{
		...
		base.Npc.Movement.SpeedController.AddSpeedControl(new NPCSpeedController.SpeedControl("HeavyFlinch", 100, 0f));
	}

	public override void Deactivate()
	{
		base.Deactivate();
		base.Npc.Movement.SpeedController.RemoveSpeedControl("HeavyFlinch");
	}
