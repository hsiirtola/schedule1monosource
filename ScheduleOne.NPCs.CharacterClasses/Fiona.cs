...
public class Fiona : NPC
{
	...
	protected override void Start()
	{
		...
		((Component)DialogueHandler).GetComponent<DialogueController>().Choices[0].isValidCheck = ShopChoiceValid;
	}
	...
	{
		if (!NetworkInitialize___EarlyScheduleOne_002ENPCs_002ECharacterClasses_002EFionaAssembly_002DCSharp_002Edll_Excuted)
		{
			NetworkInitialize___EarlyScheduleOne_002ENPCs_002ECharacterClasses_002EFionaAssembly_002DCSharp_002Edll_Excuted = true;
	...
	{
		if (!NetworkInitialize__LateScheduleOne_002ENPCs_002ECharacterClasses_002EFionaAssembly_002DCSharp_002Edll_Excuted)
		{
			NetworkInitialize__LateScheduleOne_002ENPCs_002ECharacterClasses_002EFionaAssembly_002DCSharp_002Edll_Excuted = true;
