...
public class CartelData : SaveData
{
	...
	public int HoursSinceStatusChange = 9999;
	...
	{
		Status = status;
		HoursSinceStatusChange = hoursSinceStatusChange;
		RegionInfluence = regionInfluence;
		HoursUntilNextGlobalActivity = hoursUntilNextGlobalActivity;
		RegionalActivityData = regionalActivityData;
		ActiveCartelDeal = activeCartelDeal;
		HoursUntilNextDealRequest = hoursUntilNextDealRequest;
	}
}
