...
public class PlayerEnergy : MonoBehaviour
{
	...
	protected virtual void Start()
	{
		...
		Singleton<SleepCanvas>.Instance.onSleepFullyFaded.AddListener(new UnityAction(SleepEnd));
		((Component)this).GetComponent<PlayerHealth>().onRevive.AddListener(new UnityAction(ResetEnergyDrinks));
	}

	private void MinPass()
	{
		if ((!DEBUG_DISABLE_ENERGY || (!Debug.isDebugBuild && !Application.isEditor)) && !NetworkSingleton<TimeManager>.Instance.IsSleepInProgress)
		{
