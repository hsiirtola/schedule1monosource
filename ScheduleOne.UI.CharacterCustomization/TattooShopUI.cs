...
public class TattooShopUI : CharacterCustomizationUI
{
	...
	public override void OptionSelected(CharacterCustomizationOption option)
	{
		...
		CharacterCustomizationShop.AvatarRig.ApplyBodyLayerSettings(avatarSettings, 19);
		CharacterCustomizationShop.AvatarRig.ApplyFaceLayerSettings(avatarSettings);
	}
