...
public class ColorGradingModel : PostProcessingModel
{
	...
	public struct CurvesSettings
	{
		...
		{
			master = new ColorGradingCurve(new AnimationCurve((Keyframe[])(object)new Keyframe[2]
			{
				new Keyframe(0f, 0f, 1f, 1f),
				new Keyframe(1f, 1f, 1f, 1f)
			}), 0f, loop: false, new Vector2(0f, 1f)),
			red = new ColorGradingCurve(new AnimationCurve((Keyframe[])(object)new Keyframe[2]
			{
				new Keyframe(0f, 0f, 1f, 1f),
				new Keyframe(1f, 1f, 1f, 1f)
			}), 0f, loop: false, new Vector2(0f, 1f)),
			green = new ColorGradingCurve(new AnimationCurve((Keyframe[])(object)new Keyframe[2]
			{
				new Keyframe(0f, 0f, 1f, 1f),
				new Keyframe(1f, 1f, 1f, 1f)
			}), 0f, loop: false, new Vector2(0f, 1f)),
			blue = new ColorGradingCurve(new AnimationCurve((Keyframe[])(object)new Keyframe[2]
			{
				new Keyframe(0f, 0f, 1f, 1f),
				new Keyframe(1f, 1f, 1f, 1f)
			}), 0f, loop: false, new Vector2(0f, 1f)),
