...
public abstract class BeamGeometryAbstractBase : MonoBehaviour
{
	...
	private void OnDestroy()
	{
		...
		{
			Object.DestroyImmediate((Object)(object)m_CustomMaterial);
	...
	{
		if (!Object.op_Implicit((Object)(object)GetMaster()))
		{
	...
	{
		if (Object.op_Implicit((Object)(object)beamGeom))
		{
			Object.DestroyImmediate((Object)(object)((Component)beamGeom).gameObject);
		}
	}
}
