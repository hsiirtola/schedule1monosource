...
public static class Consts
{
	...
	{
		public static readonly LayerMask LayerMaskDefault = LayerMask.op_Implicit(1);
	...
	public static class Shadow
	{
		...
		{
			return $"Can't change {((Object)comp).name} Shadow.depthMapResolution property at runtime after DepthCamera initialization";
		}
	}
