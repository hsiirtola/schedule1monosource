...
public abstract class DynamicOcclusionAbstractBase : MonoBehaviour
{
	...
	{
		m_Master = ((Component)this).GetComponent<VolumetricLightBeamSD>();
	...
	{
		if ((Object)(object)cam != (Object)null && ((Behaviour)cam).enabled && Time.frameCount != m_LastFrameRendered)
		{
			bool flag = false;
			if (!flag && updateRate.HasFlag(DynamicOcclusionUpdateRate.OnBeamMove) && !m_TransformPacked.IsSame(((Component)this).transform))
			{
				flag = true;
			}
