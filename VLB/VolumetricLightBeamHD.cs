...
public class VolumetricLightBeamHD : VolumetricLightBeamAbstractBase
{
	...
	{
		return ((Component)this).GetComponent<VolumetricCookieHD>();
	}

	public VolumetricShadowHD GetAdditionalComponentShadow()
	{
		return ((Component)this).GetComponent<VolumetricShadowHD>();
	}
	...
	public float GetInsideBeamFactorFromObjectSpacePos(Vector3 posOS)
	{
		...
		Vector2 val2 = new Vector2(((Vector2)(ref val)).magnitude, posOS.z + GetConeApexOffsetZ(counterApplyScaleForUnscalableBeam: true));
	...
	public virtual void GenerateGeometry()
	{
		...
		{
			Debug.LogErrorFormat((Object)(object)((Component)this).gameObject, "HD Beam '{0}': fallback to default quality '{1}'", new object[2]
			{
				((Object)this).name,
	...
	public void AssignPropertiesFromAttachedSpotLight()
	{
		...
		{
			intensity = SpotLightHelper.GetIntensity(val) * intensityMultiplier;
		}
		...
		if (m_ColorFromLight)
		{
			...
			if (useColorTemperatureFromAttachedLightSpot)
			{
				...
				Color val3 = ((Color)(ref color)).linear * val2;
				colorFlat = ((Color)(ref val3)).gamma;
			}
			else
			{
				colorFlat = val.color;
